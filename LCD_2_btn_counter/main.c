...
//habilitacion individual de interrupcion en cada pin del P1 y P2
#define EBOTON1 P1IE //  1= habilitado 0= deshabilitado
//Seleccion de borde de interrupcion en cada pin del P1 y P2
/*
 *  ___                          __
...
int main(void)
{
    ...
    while(1)
    {
        ...
        if(actualizarRESET)
        {
            ...
            fila=1; //indica en que posicion imprimir el contador1
            columna=3;
            LCD1602_Printf("%s",&columna,&fila,"0    ");//reinicia los valores
            fila=1; //indica en que posicion imprimir el contador2
            columna=11;
        ...
        if(actualizarLED) //se debe procesar un cambio en el LED
        {
            ...
            actualizarLED--; //disminuye las veces de actualizacion de la pantalla
            EBOTON1|=BOTON1; //habilitamos

            fila=0; //indica en que posicion imprimir el contador1
            columna=4;
        ...
        {
            EBOTON1&=~BOTON1; //deshabilitar la int del boton1
            actualizarCONTEO1--; //disminuye las veces de//actualizacion de la pantalla
            EBOTON1|=BOTON1; //habilitamos
